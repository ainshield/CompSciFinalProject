...
to go-home
      ...
      if family = "D" [ setxy 1 -2 ]
      if family = "E" [ setxy 10 -6 ]
      if family = "F" [ setxy -10 10 ]
      if family = "G" [ setxy -10 6 ]
      if family = "H" [ setxy -10 2 ]
      if family = "I" [ setxy -10 -2 ]
      if family = "J" [ setxy -10 -6 ]
end
